...
<div class="card">
  <div class="card-header">
    ...
    <div class="px-4 py-2">
      <label class="btn btn-primary" style="text-align:center" for="modal1" id="btnAddNew"><i class="fa fa-plus"></i> Add New Table</label>
    </div>
  <div class="card-body">
  ...
  <div id="css-only-modals"><input class="css-only-modal-check" id="modal1" type="checkbox" />
			...
			<h2>Fill up details to add new table</h2>
        <form style="text-align:left;margin-top:2em">
            <div class="mb-3">
              <label for="input_table_number" class="form-label">Table Number</label>
              <input type="email" class="form-control" id="input_table_number" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
              <label for="input_seats" class="form-label">Number of Seats</label>
              <input type="number" class="form-control" id="input_seats">
            </div>
            <div class="mb-3">
              <label for="input_description" class="form-label">Description (optional)</label>
